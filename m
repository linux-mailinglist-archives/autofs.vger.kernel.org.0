Return-Path: <autofs+bounces-299-lists+autofs=lfdr.de@vger.kernel.org>
Delivered-To: lists+autofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id yM56EZuHoGlvkgQAu9opvQ
	(envelope-from <autofs+bounces-299-lists+autofs=lfdr.de@vger.kernel.org>)
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 18:49:15 +0100
X-Original-To: lists+autofs@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id DA4741ACDC1
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 18:49:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id D2230305B3AC
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 17:04:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EAE37368969;
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-299-lists,autofs=lfdr.de];
	DKIM_TRACE(0.00)[manguebit.org:+];
	ASN(0.00)[asn:63949, ipnet:172.232.128.0/19, country:SG];
	MISSING_XM_UA(0.00)[];
	PRECEDENCE_BULK(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[pc@manguebit.org,autofs@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sto.lore.kernel.org:helo,sto.lore.kernel.org:rdns,manguebit.org:mid,manguebit.org:dkim,manguebit.org:email]
X-Rspamd-Queue-Id: DA4741ACDC1
