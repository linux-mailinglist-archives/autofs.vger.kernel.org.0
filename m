Return-Path: <autofs+bounces-306-lists+autofs=lfdr.de@vger.kernel.org>
Delivered-To: lists+autofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mAPCOHuUoGllkwQAu9opvQ
	(envelope-from <autofs+bounces-306-lists+autofs=lfdr.de@vger.kernel.org>)
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 19:44:11 +0100
X-Original-To: lists+autofs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BEEE1ADE6C
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 19:44:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 74DD630859C3
	for <lists+autofs@lfdr.de>; Thu, 26 Feb 2026 17:49:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CAD0E355F23;
...
X-Spamd-Result: default: False [0.14 / 15.00];
	...
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-306-lists,autofs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	FROM_NEQ_ENVFROM(0.00)[rostedt@goodmis.org,autofs@vger.kernel.org];
	TO_DN_SOME(0.00)[];
