...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4DDD94022DF
	for <lists+autofs@lfdr.de>; Tue,  7 Sep 2021 06:41:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229653AbhIGEiv (ORCPT <rfc822;lists+autofs@lfdr.de>);
        Tue, 7 Sep 2021 00:38:51 -0400
Received: from mx2.hcg.gr ([84.205.254.49]:58602 "EHLO mx2.hcg.gr"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229456AbhIGEiu (ORCPT <rfc822;autofs@vger.kernel.org>);
        Tue, 7 Sep 2021 00:38:50 -0400
DKIM-Signature: v=1; a=rsa-sha256; d=yna.gov.gr; s=selector1; c=relaxed/simple;
        q=dns/txt; i=@yna.gov.gr; t=1630989432; x=1631097432;
        h=From:Sender:Reply-To:Subject:Date:Message-Id:To:Cc:MIME-Version:Content-Type:
        Content-Transfer-Encoding:Content-ID:Content-Description:Resent-Date:Resent-From:
        Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:In-Reply-To:References:List-Id:
        List-Help:List-Unsubscribe:List-Subscribe:List-Post:List-Owner:List-Archive;
        bh=1P7tLok+AjUjoeAHHSGNt+71rhygL4oLH82a5R8dsAw=;
        b=eREEWBA7IYutseABndCrc5axXPjldxGw9tUKG5aNpTFGEdMb8E+qNzMczGtEKN5a
        zQ1Jy+mzzeaRu7TmXZ31fPSp9h8AzqtE2BPr2+NseyM18MZzCFt7OmtBqCF9b+u+
        lFWjeKyKGdTSgPNGV3bGox9cL1cy/lRP0QMnQFzXRaI=;
X-AuditID: ac138d0e-8d6d670000000931-04-6136ec7862c5
Received: from newmail.hcg.gr (Unknown_Domain [172.18.2.10])
        (using TLS with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (Client did not present a certificate)
        by mx2.hcg.gr (Symantec Messaging Gateway) with SMTP id 84.9E.02353.87CE6316; Tue,  7 Sep 2021 07:37:12 +0300 (EEST)
Received: from localhost (localhost [127.0.0.1])
        by newmail.hcg.gr (Postfix) with ESMTP id 906BE380612FBD;
        Tue,  7 Sep 2021 01:41:44 +0300 (EEST)
Received: from newmail.hcg.gr ([127.0.0.1])
        by localhost (newmail.hcg.gr [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id q5yTUdCCTubo; Tue,  7 Sep 2021 01:41:44 +0300 (EEST)
Received: from localhost (localhost [127.0.0.1])
        by newmail.hcg.gr (Postfix) with ESMTP id 4B692380612F95;
        Tue,  7 Sep 2021 01:41:44 +0300 (EEST)
X-Virus-Scanned: amavisd-new at newmail.hcg.gr
Received: from newmail.hcg.gr ([127.0.0.1])
        by localhost (newmail.hcg.gr [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id G2Z4g4cOj2Hq; Tue,  7 Sep 2021 01:41:44 +0300 (EEST)
Received: from [172.20.10.6] (unknown [129.205.113.12])
        by newmail.hcg.gr (Postfix) with ESMTPSA id 3120D380612FB9;
        Tue,  7 Sep 2021 01:41:42 +0300 (EEST)
Content-Type: multipart/mixed; boundary="===============0500337901=="
MIME-Version: 1.0
Subject: =?utf-8?q?AW=3AGesch=C3=A4ftsvorschlag=2E?=
To:     Recipients <mmastrok@yna.gov.gr>
From:   "Yi Huiman" <mmastrok@yna.gov.gr>
Date:   Mon, 06 Sep 2021 23:41:39 +0100
Reply-To: info@yi.huiman.ureil.ga
Message-Id: <20210906224142.3120D380612FB9@newmail.hcg.gr>
X-Brightmail-Tracker: 
Precedence: bulk
