Return-Path: <autofs+bounces-495-lists+autofs=lfdr.de@vger.kernel.org>
Delivered-To: lists+autofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OB/qMU7SpmnHWgAAu9opvQ
	(envelope-from <autofs+bounces-495-lists+autofs=lfdr.de@vger.kernel.org>)
	for <lists+autofs@lfdr.de>; Tue, 03 Mar 2026 13:21:34 +0100
X-Original-To: lists+autofs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 8202C1EF4CA
	for <lists+autofs@lfdr.de>; Tue, 03 Mar 2026 13:21:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id C8D4930D0F76
	for <lists+autofs@lfdr.de>; Tue,  3 Mar 2026 12:15:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A0BC1340A47;
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-495-lists,autofs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[linux_oss@crudebyte.com,autofs@vger.kernel.org];
	DKIM_TRACE(0.00)[crudebyte.com:+];
	NEURAL_HAM(-0.00)[-0.998];
	ASN(0.00)[asn:63949, ipnet:172.105.96.0/20, country:SG];
	TAGGED_RCPT(0.00)[autofs];
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[crudebyte.com:dkim,crudebyte.com:email]
